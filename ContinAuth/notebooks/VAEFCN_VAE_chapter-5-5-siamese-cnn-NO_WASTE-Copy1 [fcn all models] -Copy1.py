...
modelss = [
    ...
    VAE([16,1],[1,16],contamination=.137,l2_regularizer=.5,gamma=1.5,dropout_rate=.25,epochs=95,capacity=1,hidden_activation=activations.tanh,batch_size=32,output_activation=activations.softmax,optimizer='sgd',loss=losses.mse),
    VAE([16,1],[1,16],contamination=.1,l2_regularizer=.5,gamma=1.5,dropout_rate=.25,epochs=95,capacity=1,hidden_activation=activations.tanh,batch_size=32,output_activation=activations.softmax,optimizer='sgd',loss=losses.mse),
    VAE([16,1],[1,16],contamination=.2,l2_regularizer=.5,gamma=1.5,dropout_rate=0,epochs=95,capacity=1,hidden_activation=activations.tanh,batch_size=32,output_activation=activations.softmax,optimizer='sgd',loss=losses.mse),
    VAE([16,1],[1,16],contamination=.137,l2_regularizer=.5,gamma=1.5,dropout_rate=0,epochs=95,capacity=1,hidden_activation=activations.tanh,batch_size=32,output_activation=activations.softmax,optimizer='sgd',loss=losses.mse),
    VAE([16,1],[1,16],contamination=.1,l2_regularizer=.5,gamma=1.5,dropout_rate=0,epochs=95,capacity=1,hidden_activation=activations.tanh,batch_size=32,output_activation=activations.softmax,optimizer='sgd',loss=losses.mse),
    
    VAE([16,1],[1,16],contamination=.2,l2_regularizer=.5,gamma=1,dropout_rate=.25,epochs=95,capacity=0,hidden_activation=activations.tanh,batch_size=32,output_activation=activations.softmax,optimizer='sgd',loss=losses.mse),
    VAE([16,1],[1,16],contamination=.137,l2_regularizer=.5,gamma=1,dropout_rate=.25,epochs=95,capacity=0,hidden_activation=activations.tanh,batch_size=32,output_activation=activations.softmax,optimizer='sgd',loss=losses.mse),
    VAE([16,1],[1,16],contamination=.1,l2_regularizer=.5,gamma=1,dropout_rate=.25,epochs=95,capacity=0,hidden_activation=activations.tanh,batch_size=32,output_activation=activations.softmax,optimizer='sgd',loss=losses.mse),
    VAE([16,1],[1,16],contamination=.2,l2_regularizer=.5,gamma=1,dropout_rate=0,epochs=95,capacity=0,hidden_activation=activations.tanh,batch_size=32,output_activation=activations.softmax,optimizer='sgd',loss=losses.mse),
    VAE([16,1],[1,16],contamination=.137,l2_regularizer=.5,gamma=1,dropout_rate=0,epochs=95,capacity=0,hidden_activation=activations.tanh,batch_size=32,output_activation=activations.softmax,optimizer='sgd',loss=losses.mse),
    VAE([16,1],[1,16],contamination=.1,l2_regularizer=.5,gamma=1,dropout_rate=0,epochs=95,capacity=0,hidden_activation=activations.tanh,batch_size=32,output_activation=activations.softmax,optimizer='sgd',loss=losses.mse),
